# Hive map — public template

**Format owner:** `hive/registry/`  
**Cold-start:** [`../ORCHESTRATION.md`](../ORCHESTRATION.md)

This public file is a **format example** only. Live product pins, absolute paths, and private program status are not published here.
...
Live map (Admin only): `registry/private/LIVE-HIVE-MAP.md` — not published.
